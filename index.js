...
client.on('message', async message => {
  ...
  // List of messages to check for
  const messagesToCheck = [
    {words: ['fuck', 'shit', 'kill', 'screw', 'dmn', 'jesus christ', 'bastard', 'whore', 'gyatt', 'circumcised','obese', 'self harm', 'suicide', 'stabbed', 'death', 'skinned', 'heart attack', 'suffocate'], reply: `Oh dear, let's keep the chat family-friendly!`},
    {words: ['slut', 'meesex', 'pussy hot', 'rizz', 'sigma', 'mewing', 'wick the dick', 'shitfire', 'cuntuccino', 'fatty', 'fat', 'dead', 'stroke'], reply: 'Remember, negativity is like a boomerang - it comes back around!'},
    {words: ['farther gamer', 'justin', 'alex', 'trinity','whale', 'freak', 'hoe', 'burned', 'inhumane', 'buried', 'rot', 'hell'], reply: 'Is that your "nicest voice"'},
    ...
    {words: ['awful'], reply: `Ugh, bad days are the worst!  Is there anything I can do to cheer you up?`},
    {words: ['great'], reply: `I'm so happy it was!`},
  ];
